...
The questions in this exploratory analysis were to fulfill the requirements for the Social Statistics course SOAN 0385 @ Middlebury College in the of Spring 2017. 
...
# About the Data
I’ll be using the full set of observations from 1972-2016. 

# Abstract
 ## Include an abstract that explains what we did (methodology), why we chose this question (literature), what the findings where (results), and ideal extensions of this study (future directions)
