...
prop.table(table(gss$disagree))

gss$excellent<-(gss$health=="Excellent"|gss$helpsick==1)
prop.table(table(gss$excellent))
```
...
```{r,echo=FALSE}
t.test(gss$helpsick[gss$health=="Excellent"],gss$helpsick[gss$health=="Poor"])
```
